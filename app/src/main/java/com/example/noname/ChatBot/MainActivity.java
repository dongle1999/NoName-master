package com.example.noname.ChatBot;
...
public class MainActivity extends AppCompatActivity {
  ...
  private com.example.noname.ChatBot.ChatAdapter mAdapter;
  ...
  private void createServices() {
    watsonAssistant = new Assistant("2021-01-01", new IamAuthenticator(mContext.getString(R.string.assistant_apikey)));
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_benh_nhan_chat_voi_bac_si);
   ...
   /* String customFont = "Montserrat-Regular.ttf";
    ...
    mAdapter = new com.example.noname.ChatBot.ChatAdapter(messageArrayList);
    ...
    if (permission != PackageManager.PERMISSION_GRANTED) {
      Log.i(TAG, "Quyền ghi lại bị từ chối");
      makeRequest();
    } else {
      Log.i(TAG, "Quyền ghi lại đã được cấp");
    }
        ...
        switch (requestCode) {
            ...
            case RECORD_REQUEST_CODE: {
                ...
                if (grantResults.length == 0
                    ...
                    Log.i(TAG, "Quyền đã bị người dùng từ chối");
                } else {
                    Log.i(TAG, "Quyền đã được cấp bởi người dùng");
                }
                return;
            }
    ...
    private void recordMessage() {
        if (listening != true) {
            ...
            listening = true;
            Toast.makeText(com.example.noname.ChatBot.MainActivity.this, "Listening....Click to Stop", Toast.LENGTH_LONG).show();

        } else {
            try {
                microphoneHelper.closeInputStream();
                listening = false;
                Toast.makeText(com.example.noname.ChatBot.MainActivity.this, "Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void showError(final Exception e) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(com.example.noname.ChatBot.MainActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
    }
